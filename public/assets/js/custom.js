(function ($) {
    $(document).ready(function () {
        ...
        // csv file upload 
        $("#csv_file_upload").on("click", function () {
            var csv_file_upload = wp.media({
                title: "Upload CSV file",
                multiple: false,
            }).open().on("select", function () {
                var uploaded_csv_file = csv_file_upload.state().get("selection").first();
                var get_csv_url = uploaded_csv_file.toJSON().url;
                $("#csv_url").val(get_csv_url);
            });
        });
        ...
        // Shop CSV file importer validation 

        $("#shop_csv_file_importer").validate({
            rules: {
                shop_csv_file: {
                    required: true
                },
        ...
        $("#country_csv_file_importer").validate({
            rules: {
                cntry_csv_file: {
                    required: true
                },
        ...
        $("#state_csv_file_importer").validate({
            rules: {
                state_csv_file: {
                    required: true
                },
