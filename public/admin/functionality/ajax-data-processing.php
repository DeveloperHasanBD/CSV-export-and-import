...
function lagmp_country_form_data()
{
    ...
    if ('country_data' == $param) {
        ...
        $select_state_name       = sanitize_text_field($_POST['select_state_name']);
...
function lagmp_shop_form_data()
{
    ...
    if ('shop_data' == $param) {
        ...
        $shop_ln               = sanitize_text_field($_POST['main_shop_location']);
...
function fd_states_n_country_data()
{
    ...
    if ('get_fd_country' == $fd_param) {
        ...
        ?>
        <option value="34.0479|100.6197">Select country</option>
        <?php
...
function gmp_shop_from_inner_country()
{
    ...
    ?>
        ...
        <option value="34.0479|100.6197">Select location</option>
        <?php
        if ($is_inner_shop > 1) {
        ?>
            <script>
