			...
			<div class="row">
				...
				<div class="col-8">
					<div class="state_list_table shadow p-3 mb-5 bg-body rounded">
						...
						$delete_all_states_btn 	= $_POST['delete_all_states_btn'] ?? '';
						if ('Delete all state' == $delete_all_states_btn) {
							$wpdb->query("TRUNCATE TABLE $lagmp_states_table");
						?>
							<div class="alert alert-success alert-dismissible fade show" role="alert">
						...
						<table class="table" id="state_list_table">
							<thead>
								<tr>
									...
									<th scope="col">State lat</th>
									<th scope="col">State long</th>
									<th scope="col">

										<div class="action_btn_dgn">
											<span>Action</span>
											<form action="" method="POST">
												<input name="delete_all_states_btn" class="btn btn-warning" type="submit" value="Delete all state" onclick="return confirm('Are you sure want to delete all ?')">
											</form>
										</div>
									</th>
								</tr>
								...
								?>
									<tr>
										...
										<td class="action_btn_dgn">
											<a href="<?php echo admin_url("admin.php?page=state&state_id=$state_id"); ?>" class="btn btn-info">Update</a>
											<form action="" method="POST">
