			...
			<div class="row">
				<div class="col-12">
					...
					if ('Update shop info' == $updt_shop_btn) {
						...
						$adrs_line_one = sanitize_text_field($_POST['adrs_line_one']);
						$adrs_line_two = sanitize_text_field($_POST['adrs_line_two']);
						$tell = sanitize_text_field($_POST['tell']);
						$fax = sanitize_text_field($_POST['fax']);
						$website = sanitize_text_field($_POST['website']);
						$email = sanitize_text_field($_POST['email']);
						$info = sanitize_text_field($_POST['info']);
						$info_three = sanitize_text_field($_POST['info_three']);
								...
								<div class="row">
									<div class="col-6">
										<div class="form-group">
											<label for="select_state_name" class="control-label">State</label>
										...
										<div class="form-group">
											<label for="shop_location" class="control-label">Shop location</label>
									...
									<div class="col-6">
										...
										<div class="form-group">
											<label for="info_three" class="control-label">Info #3</label>
		...
		<div class="row">
			<div class="col-12">
				<div class="shop_list">
					...
					$delete_all_shop_btn 	= $_POST['delete_all_shop_btn'] ?? '';
					if ('Delete all shop' == $delete_all_shop_btn) {
						// $wpdb->delete($updt_shop_details_table);
						$wpdb->query("TRUNCATE TABLE $updt_shop_details_table");
					?>
						<div class="alert alert-success alert-dismissible fade show" role="alert">
							...
							<tr>
								...
								<th scope="col">
									<div class="action_btn_dgn">
										<span>Action</span>
										<form action="" method="POST">
											<input name="delete_all_shop_btn" class="btn btn-warning" type="submit" value="Delete all shop" onclick="return confirm('Are you sure want to delete all ?')">
										</form>
									</div>
								</th>
							</tr>
						...
						<tbody>
							...
							?>
								<tr>
									...
									<td>
										<div class="action_btn_dgn">
											<a href="<?php echo admin_url("admin.php?page=shop&shop_id=$shop_id"); ?>" class="btn btn-info">Update</a>
											<form action="" method="POST">
